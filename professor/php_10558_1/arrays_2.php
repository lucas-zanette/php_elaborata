...
<html>
   ...
   <body>
      ...
      <p>O nome de um array faz referência à sequencia.</p>
      <p>Para acessarmos um elemento de um array precisamos do 
nome do array e do índice do elemento dentro do array;</p>
      <pre>
